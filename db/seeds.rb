...
topics=["sports","pop culture","food","nonsense"]
authors=[Faker::Name.name, Faker::Name.name, Faker::Name.name, Faker::Name.name,Faker::Name.name]

25.times do |i|
    post=BlogPost.create({topic:topics[rand(0..3)],title: Faker::Book.title, content: Faker::Lorem.paragraph(sentence_count: 80) + Faker::Lorem.paragraph(sentence_count: 80) +  Faker::Lorem.paragraph(sentence_count: 80),author:authors[rand(0..4)]})
